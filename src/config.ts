...
const jobify: Project = {
  ...
  password: password`,
  languages: ['JavaScript', 'React', 'Node.js', 'Express', 'PostgreSQL', 'Bcrypt'],
...
export const PROJECTS: Array<Project> = [randomRhythms, inco, jobify, webDesign];
...
export const SKILLS: Array<Skill> = [
  ...
  {name: 'React Native', svg: 'react.svg', fill: '#222222'},
  {name: 'Node.js', svg: 'react.svg', fill: '#222222'},
  {name: 'tRPC', svg: 'react.svg', fill: '#222222'},
  {name: 'Python', svg: 'python.svg', fill: '#1d405d'},
  {name: 'PostgreSQL', svg: 'postgres.svg', fill: '#336791'},
  {name: 'MongoDB', svg: 'postgres.svg', fill: '#336791'},
...
const tco: Experience = {
  ...
  highlights: ['Led data sanitization project that reduced average custom reporting time by 25%'],
};
...
const bws: Experience = {
  ...
  highlights: ['Automated the gift entry process, reducing time by 90% and eliminating errors'],
};

export const EXPERIENCES: Array<Experience> = [clever, rithm, greatLeap, betterment, tco];
