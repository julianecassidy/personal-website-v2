...
export default function ContactForm() {
  ...
  const charLimitClass =
    formData.message.length < MAX_CHAR
  ...
  const buttonClass =
    "block mx-auto mt-4 bg-button rounded px-2 py-2 text-center text-white whitespace-nowrap";
  ...
  return (
    ...
    >
      ...
      <label htmlFor="name" className={label}>
        Name: <span className={inputRequired}>*</span>
      </label>
      <input
        type="text"
        id="name"
      ...
      <label htmlFor="email" className={label}>
        Email: <span className={inputRequired}>*</span>
      </label>
      <input
        type="email"
        id="email"
        ...
        onChange={handleChange}
      />
      <label htmlFor="messsage" className={label}>
        Message: <span className={inputRequired}>*</span>
      </label>
      <textarea
        name="message"
        id="message"
      ...
      >{`${formData.message.length}/300 characters`}</div>
